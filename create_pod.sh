...
SEARCH_IMAGE=docker.io/getmeili/meilisearch:v1.3
...
MEILI_MASTER_KEY=rgzUyt-OYHJWzjoojcTDeLE4waAmsK67mdH6AYXS93k
...
podman create \
    ...
    -v $(pwd)/database/sql/initdb.d:/docker-entrypoint-initdb.d:Z \
    --pod $POD_NAME \
    $PGSQL_IMAGE
...
podman create \
    ...
    -v $(pwd)/database/pgadmin/servers.json:/pgadmin4/servers.json:Z \
